...
const Screen3 = () => {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/images/screen3.png')} style={styles.image} resizeMode="contain" />
      <Text style={styles.subtitleText}>Partnership with our local Farmers{'\n'}providing fresh produce from the farm.</Text>
